...
#' contains the scores measured by Rater 2 (or at time 2) of the 100 subjects
#' and dataset dep_ex_df1 contains the scores measured by Rater 1 (or at time
#' 1) of the same 100 subjects.
#'

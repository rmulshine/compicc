...
The two functions in compicc calculate the confidence interval with a user-defined confidence level of the difference of one dataframe's intraclass correlation coefficient (ICC) versus another dataframe's ICC. These two functions are **dep_ci()** and **indep_ci()**, whose uses will be explained later.
